...
public class Controller {
    ...
    public void run() {
        ...
        if (data != -1) {
            ...
            this.productManager = new ProductManager(data);
     ...
     */
    private void readReviews(String product, String brand) {
     ...
     * @param brand la marca del producto.
     */
    private void reviewProduct(String prod, String brand) {
     ...
     */
    private void addToCart(String productName, String brand, String shopName, Float price, String category, int fundationYear, String descr, float earnings, String businessModel, float loyaltyThres, String sponsor, ArrayList<String> reviews) {
     ...
     *
     */
    private void checkout(ArrayList<String> shops) {
        view.spacing();
